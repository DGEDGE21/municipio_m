...
from .views import BairroListView, MercadoListView, cadastrar_mercados,MunicipeListView,MunicipeUpdateView, MunicipeDetailView, MunicipeCreateView, MunicipePagamentosView
